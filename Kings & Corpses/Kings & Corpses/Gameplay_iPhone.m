...
#import "Gameplay_iPhone.h"

@interface Gameplay_iPhone ()

@end

@implementation Gameplay_iPhone
...
-(void)gameOver {
    ...
    if (gamemode == 2) {
        ...
        if (zombiesDefeated == true) {
            ...
            [deadScreen setImage:[UIImage imageNamed:[NSString stringWithFormat:@"win-screen.png"]]];
            deadScreen.alpha = 1;
            tweetButton.alpha = 1;
            skipButton.alpha = 0;
            ...
            [deadScreen setImage:[UIImage imageNamed:[NSString stringWithFormat:@"dead-screen.png"]]];
            deadScreen.alpha = 1;
            tweetButton.alpha = 1;
            skipButton.alpha = 0;
...
-(void)loadLevel {
    ...
    if (selectedTheme == 1) {
        kingImage = [UIImage imageNamed:@"king.png"];
        pawnImage = [UIImage imageNamed:@"pawn.png"];
        zombieImage = [UIImage imageNamed:@"zombie.png"];
        knightImage = [UIImage imageNamed:@"knight.png"];
    }
    else if (selectedTheme == 2) {
        kingImage = [UIImage imageNamed:@"king-xl.png"];
        pawnImage = [UIImage imageNamed:@"pawn-xl.png"];
        zombieImage = [UIImage imageNamed:@"zombie-xl.png"];
        knightImage = [UIImage imageNamed:@"knight-xl.png"];
    }
    else if (selectedTheme == 3) {
        kingImage = [UIImage imageNamed:@"king-alpha.png"];
        pawnImage = [UIImage imageNamed:@"pawn-alpha.png"];
        zombieImage = [UIImage imageNamed:@"zombie-alpha.png"];
        knightImage = [UIImage imageNamed:@"knight-alpha.png"];
    }
    else if (selectedTheme == 4) {
        kingImage = [UIImage imageNamed:@"king-outline.png"];
        pawnImage = [UIImage imageNamed:@"pawn-outline.png"];
        zombieImage = [UIImage imageNamed:@"zombie-outline.png"];
        knightImage = [UIImage imageNamed:@"knight-outline.png"];
    }
    else if (selectedTheme == 5) {
        kingImage = [UIImage imageNamed:@"king-doge.png"];
        pawnImage = [UIImage imageNamed:@"pawn-doge.png"];
        zombieImage = [UIImage imageNamed:@"zombie-doge.png"];
        knightImage = [UIImage imageNamed:@"knight-doge.png"];
    }
    else {
        kingImage = [UIImage imageNamed:@"king.png"];
        pawnImage = [UIImage imageNamed:@"pawn.png"];
    ...
    if (a1p == 0) {
        [a1i setImage:[UIImage imageNamed:[NSString stringWithFormat:@"empty.png"]]];
    }
    if (a2p == 0) {
        [a2i setImage:[UIImage imageNamed:[NSString stringWithFormat:@"empty.png"]]];
    }
    if (a3p == 0) {
        [a3i setImage:[UIImage imageNamed:[NSString stringWithFormat:@"empty.png"]]];
    }
    if (a4p == 0) {
        [a4i setImage:[UIImage imageNamed:[NSString stringWithFormat:@"empty.png"]]];
    }
    if (b1p == 0) {
        [b1i setImage:[UIImage imageNamed:[NSString stringWithFormat:@"empty.png"]]];
    }
    if (b2p == 0) {
        [b2i setImage:[UIImage imageNamed:[NSString stringWithFormat:@"empty.png"]]];
    }
    if (b3p == 0) {
        [b3i setImage:[UIImage imageNamed:[NSString stringWithFormat:@"empty.png"]]];
    }
    if (b4p == 0) {
        [b4i setImage:[UIImage imageNamed:[NSString stringWithFormat:@"empty.png"]]];
    }
    if (c1p == 0) {
        [c1i setImage:[UIImage imageNamed:[NSString stringWithFormat:@"empty.png"]]];
    }
    if (c2p == 0) {
        [c2i setImage:[UIImage imageNamed:[NSString stringWithFormat:@"empty.png"]]];
    }
    if (c3p == 0) {
        [c3i setImage:[UIImage imageNamed:[NSString stringWithFormat:@"empty.png"]]];
    }
    if (c4p == 0) {
        [c4i setImage:[UIImage imageNamed:[NSString stringWithFormat:@"empty.png"]]];
    }
    ...
    if (a1p == 5) {
        [a1i setImage:[UIImage imageNamed:[NSString stringWithFormat:@"necromancer.png"]]];
    }
    if (a2p == 5) {
        [a2i setImage:[UIImage imageNamed:[NSString stringWithFormat:@"necromancer.png"]]];
    }
    if (a3p == 5) {
        [a3i setImage:[UIImage imageNamed:[NSString stringWithFormat:@"necromancer.png"]]];
    }
    if (a4p == 5) {
        [a4i setImage:[UIImage imageNamed:[NSString stringWithFormat:@"necromancer.png"]]];
    }
    if (b1p == 5) {
        [b1i setImage:[UIImage imageNamed:[NSString stringWithFormat:@"necromancer.png"]]];
    }
    if (b2p == 5) {
        [b2i setImage:[UIImage imageNamed:[NSString stringWithFormat:@"necromancer.png"]]];
    }
    if (b3p == 5) {
        [b3i setImage:[UIImage imageNamed:[NSString stringWithFormat:@"necromancer.png"]]];
    }
    if (b4p == 5) {
        [b4i setImage:[UIImage imageNamed:[NSString stringWithFormat:@"necromancer.png"]]];
    }
    if (c1p == 5) {
        [c1i setImage:[UIImage imageNamed:[NSString stringWithFormat:@"necromancer.png"]]];
    }
    if (c2p == 5) {
        [c2i setImage:[UIImage imageNamed:[NSString stringWithFormat:@"necromancer.png"]]];
    }
    if (c3p == 5) {
        [c3i setImage:[UIImage imageNamed:[NSString stringWithFormat:@"necromancer.png"]]];
    }
    if (c4p == 5) {
        [c4i setImage:[UIImage imageNamed:[NSString stringWithFormat:@"necromancer.png"]]];
    }
}
