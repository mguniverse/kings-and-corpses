...
#import "Tutorial_iPad.h"

@interface Tutorial_iPad ()

@end

@implementation Tutorial_iPad
...
-(IBAction)tutorial {
    ...
    if (tutorialPage == 1) {
        ...
        [tutorialScreen setImage:[UIImage imageNamed:[NSString stringWithFormat:@"king-large.png"]]];
        ...
        tutorialLabel.text = [NSString stringWithFormat:@""];
        [tutorialScreen setImage:[UIImage imageNamed:[NSString stringWithFormat:@"zombie-large.png"]]];
        ...
        tutorialLabel.text = [NSString stringWithFormat:@""];
        [tutorialScreen setImage:[UIImage imageNamed:[NSString stringWithFormat:@"pawn-large.png"]]];
        ...
        tutorialLabel.text = [NSString stringWithFormat:@""];
        [tutorialScreen setImage:[UIImage imageNamed:[NSString stringWithFormat:@"knight-large.png"]]];
