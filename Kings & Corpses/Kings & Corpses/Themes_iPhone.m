...
#import "Themes_iPhone.h"

@interface Themes_iPhone ()

@end

@implementation Themes_iPhone
...
-(void)loadTheme {
    ...
    if (currentTheme == 1) {
        [a1t setImage:[UIImage imageNamed:[NSString stringWithFormat:@"king.png"]]];
        [a2t setImage:[UIImage imageNamed:[NSString stringWithFormat:@"pawn.png"]]];
        [a3t setImage:[UIImage imageNamed:[NSString stringWithFormat:@"zombie.png"]]];
        [a4t setImage:[UIImage imageNamed:[NSString stringWithFormat:@"knight.png"]]];
        ...
        [a1t setImage:[UIImage imageNamed:[NSString stringWithFormat:@"king-xl.png"]]];
        [a2t setImage:[UIImage imageNamed:[NSString stringWithFormat:@"pawn-xl.png"]]];
        [a3t setImage:[UIImage imageNamed:[NSString stringWithFormat:@"zombie-xl.png"]]];
        [a4t setImage:[UIImage imageNamed:[NSString stringWithFormat:@"knight-xl.png"]]];
        ...
        [a1t setImage:[UIImage imageNamed:[NSString stringWithFormat:@"king-alpha.png"]]];
        [a2t setImage:[UIImage imageNamed:[NSString stringWithFormat:@"pawn-alpha.png"]]];
        [a3t setImage:[UIImage imageNamed:[NSString stringWithFormat:@"zombie-alpha.png"]]];
        [a4t setImage:[UIImage imageNamed:[NSString stringWithFormat:@"knight-alpha.png"]]];
        ...
        [a1t setImage:[UIImage imageNamed:[NSString stringWithFormat:@"king-outline.png"]]];
        [a2t setImage:[UIImage imageNamed:[NSString stringWithFormat:@"pawn-outline.png"]]];
        [a3t setImage:[UIImage imageNamed:[NSString stringWithFormat:@"zombie-outline.png"]]];
        [a4t setImage:[UIImage imageNamed:[NSString stringWithFormat:@"knight-outline.png"]]];
        ...
        [a1t setImage:[UIImage imageNamed:[NSString stringWithFormat:@"king-doge.png"]]];
        [a2t setImage:[UIImage imageNamed:[NSString stringWithFormat:@"pawn-doge.png"]]];
        [a3t setImage:[UIImage imageNamed:[NSString stringWithFormat:@"zombie-doge.png"]]];
        [a4t setImage:[UIImage imageNamed:[NSString stringWithFormat:@"knight-doge.png"]]];
